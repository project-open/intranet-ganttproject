...
SELECT im_component_plugin__new (
        ...
        null,                           -- view_name
        -10,                            -- sort_order
	'im_table_with_title [lang::message::lookup "" intranet-ganttproject.Scheduling "Scheduling"] [im_ganttproject_component -project_id $project_id -current_page_url $current_url -return_url $return_url -export_var_list [list project_id]]'
);
